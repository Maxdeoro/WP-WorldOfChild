                                        ...
                                        <div class="row">
                                            <div class="col-lg-7 offset-1">
                                                ...
                                                <?php
                                                    ...
                                                    if ($field == 'on') {
                                                        ?>
                                                            <a href="<?php the_field('button_link') ?>" class="button">Learn more</a>
                                                        <?php
                                                    }
                                                ?>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="specialists__img" src="<?php the_field('team_image'); ?>">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="contacts__map">
                                <?php echo do_shortcode('[mapengine id="131"]'); ?>
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:+797867834347"><?php the_field('phone1'); ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Phone №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:+797867834358"><?php the_field('phone2'); ?></a>
                                    </div>
                                </div>
                            </div>
                            <div class="contacts__mail">
                                Or email us
                                <a href="mailto:mirdetstva@gmail.com"><?php the_field('email'); ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                                        ...
                                        ?>
                                            <li class="glide__slide">
                                                <div class="feedslider__title">
                                                    <?php the_field('recent_post_title'); ?>
                                                </div>
                                                <div class="feedslider__text">
                                                    <?php the_field('recent_post_text'); ?>
                                                </div>
                                            </li>
                                        <?php
                                        }
